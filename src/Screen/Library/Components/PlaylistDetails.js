...
const PLaylistDetails = (props) => {
  ...
  return (
    <ScrollView style={{ flex: 1 }}>
      ...
      <TouchableOpacity style={{ position: 'absolute', left: 10 }} onPress={() => props.navigation.goBack()}>
        <CustomIcon iconType='AntDesign' name='left' size={20} color='#9d9d9d' />
      </TouchableOpacity>

      <View style={styles.playlistImageContainer} >
        <View style={styles.albumImage}  >
          <CustomIcon iconType='Entypo' name='folder-music' size={90} color='#ffffff' />
        </View>
      </View>
        ...
        <View style={{ flexDirection: 'row' }} >
          <View>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 5 }}>
              <CustomIcon iconType="EvilIcons" name="user" size={25} color='#000000' />
              <Text >
                {userName}
              </Text>
            </View>
            <View style={{ flexDirection: 'row' }}>
              <TouchableOpacity style={{ marginRight: 10 }}>
                <CustomIcon iconType="AntDesign" name='download' size={25} color='#636363' />
              </TouchableOpacity>
              <TouchableOpacity style={{ marginRight: 10 }}>
                <CustomIcon iconType="Entypo" name='share' size={25} color='#636363' />
              </TouchableOpacity>
              <TouchableOpacity style={{ marginRight: 10 }}>
                <CustomIcon iconType="MaterialIcons" name='more-horiz' size={25} color='#636363' />
              </TouchableOpacity>
            </View>
          </View>
          {(trackList.length != 0) ?
            (<TouchableOpacity onPress={() => playAll()} style={styles.playPlaylistButton}>
              <CustomIcon iconType="AntDesign" name="play" size={60} color="#00f040" />
            </TouchableOpacity>)
            : null}
